...
void CClient::SendInput()
{
	...
	if(m_DummyConnected)
	{
		...
		if(g_Config.m_ClDummyCopyMoves){
			...
			if(g_Config.m_ClDummyCopyMovesMirror&1)		DummyInput.m_Direction = -DummyInput.m_Direction;  // Mirror Direction
			if(g_Config.m_ClDummyCopyMovesMirror&1<<1)	DummyInput.m_TargetX = -DummyInput.m_TargetX;      // Mirror Spin
		}
